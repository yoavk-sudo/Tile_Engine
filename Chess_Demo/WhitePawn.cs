...
{
    internal class WhitePawn : ChessPiece
    {       
        ...
        public static void ConvertPawnToQueen(TileObject pawn)
        {
            Queen queen = new Queen();
            Sprite sprite = new("a", "ball");

            queen.CreateTileObject(pawn.CurrentTile, pawn.Owner, sprite);
            pawn.DestroyChildren();
        }
    }
}
